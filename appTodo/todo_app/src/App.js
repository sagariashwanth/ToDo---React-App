  ...
  useEffect(() => {
    db.collection("todos")
      ...
      .onSnapshot((snapshot) => {
        ...
        //this below line is for creating delete function in todo and also we create object as id becoz we use
        // it in Todo.js
        setTodos(
    ...
    <div className="App">
      ...
      <ul>
        {todos.map((todo) => (
          ...
          <Todo todo={todo} /> //passing in the above todo object here
        ))}
      </ul>
    </div>
  );
